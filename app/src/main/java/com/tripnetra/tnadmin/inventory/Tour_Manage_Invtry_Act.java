...
public class Tour_Manage_Invtry_Act extends AppCompatActivity {
   ...
   // CustomLoading cloading;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tour_manage_invtry);
...
*/
    ...
    public void Submit(View view) {
        ...
        if(carname.equals("")){
            ...
            Toast.makeText(this,"Enter Partial Price",Toast.LENGTH_SHORT).show();
        }else {
           // cloading.show();
           ...
           /* new VolleyRequester(this).ParamsRequest(1, TOUR_DETAIL_URL, cloading, params, false, response -> {
                cloading.dismiss();
                new AlertDialog.Builder(Tour_Manage_Invtry_Act.this)
                        .setMessage(response)
                        .setPositiveButton("Ok", (dialog, which) -> {
                            Intent intent = new Intent(Tour_Manage_Invtry_Act.this, Tour_Invtry_Details_Act.class);
           ...
           StringRequest stringRequest = new StringRequest(Request.Method.POST,"https://tripnetra.com/androidphpfiles/adminpanel/tour_details.php",response -> {
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(Objects.requireNonNull(Tour_Manage_Invtry_Act.this));
    ...
    private void getinvtry_details() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://tripnetra.com/androidphpfiles/adminpanel/tour_details.php", response -> {
            ...
            if(response.equals("") || response.equals("null")){
                Toast.makeText(Tour_Manage_Invtry_Act.this,"Avalability Not Avaialble",Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(Tour_Manage_Invtry_Act.this, e.getMessage(), Toast.LENGTH_SHORT).show();

                Utils.setSingleBtnAlert(Tour_Manage_Invtry_Act.this, "SomeThing Went Wromg\nPlease Try Again", "Ok", false);

            }

        }, error -> {

            Utils.setSingleBtnAlert(Tour_Manage_Invtry_Act.this, "SomeThing Went Wromg", "Ok", false);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Tour_Manage_Invtry_Act.this);
        requestQueue.add(stringRequest);
    ...
    /*private void getinvtry_details() {
        ...
        new VolleyRequester(this).ParamsRequest(1, TOUR_DETAIL_URL, cloading, params, false, response -> {
            ...
            try {
                ...
                //e.printStackTrace();
                Toast.makeText(Tour_Manage_Invtry_Act.this,"Technical error",Toast.LENGTH_SHORT).show();
            }
        });
