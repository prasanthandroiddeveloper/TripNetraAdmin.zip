...
public class Adult_count1 extends AppCompatActivity {

    String Sdate,Edate,Cname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adult_count1);
        ...
        Cname = bb.getString("city_name");
        chart = findViewById(R.id.chart);

       // Toast.makeText(this, Sdate+" "+Edate+" "+Cname, Toast.LENGTH_SHORT).show();
       getdata();
    ...
    private void getdata() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,Url, response -> {
            ...
            try {
                ...
                RecyclerView recyclerView = findViewById(R.id.CNamesRVs);

                recyclerView.setVisibility(View.VISIBLE);
                recyclerView.setLayoutManager(new LinearLayoutManager(Adult_count1.this));
                ...
                recyclerView.setAdapter(new Adult_count1.hotel_recycle_adapter(list));
    ...
    public class hotel_recycle_adapter  extends RecyclerView.Adapter<Adult_count1.hotel_recycle_adapter.ViewHolder>  {
        ...
        @NonNull
        @Override
        public Adult_count1.hotel_recycle_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new Adult_count1.hotel_recycle_adapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.cnamesrecycler, parent, false));
        }


        @SuppressLint("SetTextI18n")
        @Override
        public void onBindViewHolder(@NonNull Adult_count1.hotel_recycle_adapter.ViewHolder vh, int pos) {
