...
public class Session {
    ...
    public void setUserDet(String id, String logid, String utype, String uname, String UTId, String desid){
        editor.putString("userid",id);
        editor.putString("userlogid",logid);
        editor.putString("usertype",utype);
        editor.putString("username",uname);
        editor.putString("usertype_id",UTId);
        editor.putString("desgid",desid);
        editor.commit();
    }
    ...
    public String getdesigid(){return prefs.getString("desgid","");}
