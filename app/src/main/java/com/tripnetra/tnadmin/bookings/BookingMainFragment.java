...
public class BookingMainFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       ...
       // DataURL = "https://tripnetra.com/prasanth/androidphpfiles/test/adminpanel"+ReportType+"bookingreports.php";
        ...
        new VolleyRequester(activity).ParamsRequest(1, DataURL, cloading, params, false, response -> {
            ...
            if (response.equals("No Result")) {
                ...
                try {
                    ...
                    if (slimit == 0) {
                        recycleAdapter = new Booking_Recycler_Adapter(list,getContext());
