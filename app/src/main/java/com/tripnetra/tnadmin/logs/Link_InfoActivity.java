...
public class Link_InfoActivity extends AppCompatActivity {
    ...
    String  adult_count, child_count, room_price,
            ...
            city1, desc1,cSId4,descrip,acp1,pprc1,html,itenc,vehicle;
    List<String> itlist, bilist, plist,cnamesList,capcList,cplsit,cpricelsit,acplist,tlist;
    String bndl, itneray, price, FromDate, ToDate, DispCin, DispCout, test, enc,UserName,cityname,cSName, cSId,bndlc,cSId2,cSId3,stax,tax;
    ...
    EditText mPreview;
    EditText adultcunt,childcunt,city,cartype,capacity,carprice,htltype,roomtype,roomprice,totalp,gtprc,servicetax,desc,actual_price,partial_price,vchname;
    TextView responsecheck1,CindateTv,CinmonthTv,CindayTv,ddateTv,dmonthTv,ddayTv,cdate,ac,pc,Ttv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ToDate = Utils1.DatetoStr(System.currentTimeMillis(), 0);
        setdate();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, HttpUrl,
            ...
            protected Map<String, String> getParams() {
                ...
                if(!vehicle.equals("")){
                    ...
                    Log.i("rams", String.valueOf(params));
