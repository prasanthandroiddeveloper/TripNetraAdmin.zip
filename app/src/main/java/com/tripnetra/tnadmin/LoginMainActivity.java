            ...
            new VolleyRequester(this).ParamsRequest(1, LOGIN_URL, cloading, params, false, response -> {
                ...
                try {
                    ...
                    if (!jObj.getBoolean("error")) {
                        ...
                        String Desid=jObj.getJSONObject("userdata").getString("designation_details_id");

                        Log.i("des",Desid);

                        session.setUserDet(jObj.getString("uid"),DUserid,typ,jObj.getJSONObject("userdata").getString("admin_name"),id,Desid);
